...
//
// 03-Jul-26  DWW     1  Added bad-packet counter
//=============================================================================
...
module ecdcom_bad_packet_filter #
(
    parameter DW             = 512,
...
(
    ...
    // The number of bad packets since reset
    output reg[31:0] bad_packet_count,
...
//=============================================================================
// Here we count the number of bad packets
//=============================================================================
always @(posedge clk) begin
    if (resetn == 0)
        bad_packet_count <= 0;
    else
        bad_packet_count <= bad_packet_count + bad_packet_strb;
end
//=============================================================================
