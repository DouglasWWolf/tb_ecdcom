...
module ecdcom_imp_TQ7XOV
  ...
  reset_man_imp_1JHDNG8 reset_man
       (.clk(clk),
...
module reset_man_imp_1JHDNG8
  ...
  wire clk;
  wire ecdcom_reset_ctl_0_reset_out;
  wire reset_done;
  wire reset_stb;
  wire [0:0]resetn_out;
  ...
  top_level_ecdcom_reset_ctl_0_0 ecdcom_reset_ctl
       (.clk(clk),
        .reset_done(reset_done),
        .reset_stb(reset_stb),
        .resetn_out(ecdcom_reset_ctl_0_reset_out));
  top_level_proc_sys_reset_0_1 reset_manager
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
        .ext_reset_in(ecdcom_reset_ctl_0_reset_out),
        .interconnect_aresetn(resetn_out),
...
(* CORE_GENERATION_INFO = "top_level,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=top_level,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=34,numReposBlks=28,numNonXlnxBlks=0,numHierBlks=6,maxHierDepth=2,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=18,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "top_level.hwdef" *) 
module top_level
   (CLK100MHZ,
    CPU_RESETN,
    UART_rxd,
